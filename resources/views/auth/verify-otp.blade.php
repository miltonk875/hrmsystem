            ...
            <div class="login-form">
                <div class="contents">
                    <div class="form-container">
                        <img src="{{ asset('image/MyConferencE.png') }}" alt="Company Logo" class="logo ai-logo" style="width: 250px; height: auto; margin-bottom: 30px; margin-top: 0; position: static; top: 0;">
                        <h5 class="mb-3">OTP Verification</h5>
                        <p class="text-muted">Enter your OTP for verify your email</p>
                        @if($email)
                        <p id="countdown-text">
                            OTP will be expired in <span id="minutes">02</span>:<span id="seconds">00</span>
                        </p>
                        @endif
                        <form method="post" action="{{ route('verify.otp') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="otp" placeholder="Enter your OTP Code" autofocus>
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Verify</button><br><br>
                        </form>
