                        ...
                        <div class="form-container">
                            ...
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('email')
                                    <span style="float: left;position: relative;bottom: 10px;" class="text-danger">{{ $message}}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="password" class="form-control" name="password" placeholder="Enter your password">
                                        <div class=""><i class="icon-lock"></i></div>
                                    </div>
                                    @error('password')
                                    <span style="float: left;position: relative;bottom: 10px;" class="text-danger">{{ $message}}</span>
                                    @enderror
...
<!--                                    <a href="{{URL::to('forgot-password')}}" class="text-decoration-none" style="font-size: 14px; color: #0098FF;">
                                        Forgot Password?
                                    </a>-->
                                </div><br>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-sign-in"></i> Login</button>
                                <button type="button" onclick="window.location.href ='{{URL::to('user-registration')}}'" class="btn btn-secondary"><i class="fa fa-pencil"></i> New User Registration</button>
                            </form>
                        </div>
                    </div>
                </div>
