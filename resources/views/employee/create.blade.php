...
<div class="row">
    <div class="col-md-12">
        <div class="tile dive-border">
            <div class="tile-body">
                <form method="POST" id="postEmplyeeForm">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="email" id="getEmailAddress" placeholder="Enter Email Address" value="{{ old('email') }}">
    ...
    $(document).ready(function () {
        $(document).on('blur', '#getEmailAddress', function () {
            ...
            if (email.length > 0) {
                $.ajax({
                    type: 'GET',
                    url: '{{route("check.duplicate.email")}}',
                    data: {email: email},
                    async: false,
                    dataType: 'json',
